...
- Five-minute FX quote locks
- Duplicate request, recipient allowlist, and spending-policy checks
...
`/`, `/dashboard`, `/recipients`, `/recipients/new`, `/transfer/new`, `/recurring`, `/history`, and `/verify/[token]`.
